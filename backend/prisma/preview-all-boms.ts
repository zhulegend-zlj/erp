...
const CFG: ProductCfg[] = [
  ...
  { file: 'MPM/RM-CS MPM RFCL-BOM清单-最新版.xlsx', productSku: 'CS-MPM-JLD', productName: 'CS MPM 拨片（JLD 出货·不锁碳纤板）', productNameEn: 'CS MPM JLD', miscPrefix: 'CSMPM-', renameIds: { 'P1806-10928': 'P1806-10928-MPM' }, nameOverride: { 'M3 x 12 平头内六角螺丝': 'ESTP-11186' } },
