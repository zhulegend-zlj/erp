...
> 生成时间：2026-08-22（家里电脑；本轮=零件页按 CSP_V3 清单表格口径布局 + 零件表新增 7 个表格列字段 + 清空后逐列全新导入 CSP_V3，见「当前阶段」与第 3 节；工厂电脑最新提交为 `fce0d70`）
>
